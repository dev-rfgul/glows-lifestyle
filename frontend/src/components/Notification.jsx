...
//             <div className="absolute inset-0 border-2 border-red-400 rounded-xl animate-ping opacity-20"></div>
//             <div className="absolute inset-0 border border-red-300 rounded-xl animate-pulse"></div>
//         </div>
//     );
// };
...
//         case 'error':
//             return <div className={`${baseClass} bg-red-500 animate-pulse`}>!</div>;
//         case 'info':
